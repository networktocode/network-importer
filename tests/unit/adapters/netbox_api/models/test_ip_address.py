...
def test_create_ip_address_interface(requests_mock, netbox_api_base):
    ...
    ip_address = NetboxIPAddress.create(dsync=netbox_api_base, ids=dict(address="10.63.0.2/31"), attrs=dict(interface_name="TenGigabitEthernet1/0/1", device_name="HQ-CORE-SW02"))
